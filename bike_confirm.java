...
public class bike_confirm {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					bike_confirm window = new bike_confirm();
	...
	private void initialize() {
		...
		btnConfirmBooking.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
					...
					String query1="select VRegNo from v_details where VID=2 and status ='available';";
					...
					{	
						...
						String query = "insert into booking(VRegNo,CID,Sloc, Dloc, DateOfBooking, TimeOfBooking,rpkm,distance) values ('"+VR+"','"+cid+"','"+S+"','"+D+"','"+String.valueOf(java.time.LocalDate.now())+"','"+String.valueOf(java.time.LocalTime.now())+"',6,'"+dis+"'); ";
		...
		btnConfirmBooking.setBackground(new Color(255, 182, 193));
		...
		CID.setIcon(new ImageIcon("E:\\harshu\\documents\\engg\\5th sem\\DBMS Project\\pictures\\ss1.jpg"));
