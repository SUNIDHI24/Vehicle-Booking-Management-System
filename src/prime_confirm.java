...
public class prime_confirm {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					prime_confirm window = new prime_confirm();
	...
	private void initialize() {
		...
		lblSourceLocation.setForeground(Color.LIGHT_GRAY);
		...
		lblDestinationLocation.setForeground(Color.LIGHT_GRAY);
		...
		btnConfirmBooking.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
					...
					String query1="select VRegNo from v_details where VID=5 and status ='available';";
					...
					{	
						...
						String query = "insert into booking(VRegNo,CID,Sloc, Dloc, DateOfBooking, TimeOfBooking,rpkm,distance) values ('"+VR+"','"+cid+"','"+S+"','"+D+"','"+String.valueOf(java.time.LocalDate.now())+"','"+String.valueOf(java.time.LocalTime.now())+"',20,'"+dis+"'); ";
		...
		btnConfirmBooking.setBackground(UIManager.getColor("FormattedTextField.selectionBackground"));
		...
		CID.setIcon(new ImageIcon("E:\\harshu\\documents\\engg\\5th sem\\DBMS Project\\pictures\\ca.jpg"));
		CID.setBounds(0, 0, 784, 461);
