...
public class mini_confirm {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					mini_confirm window = new mini_confirm();
	...
	private void initialize() {
		...
		lblSourceLocation.setForeground(Color.WHITE);
		...
		lblDestinationLocation.setForeground(Color.WHITE);
		...
		btnConfirmBooking.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
					...
					String query1="select VRegNo from v_details where VID=3 and status ='available';";
					...
					{	
						...
						String query = "insert into booking(VRegNo,CID,Sloc, Dloc, DateOfBooking, TimeOfBooking,rpkm,distance) values ('"+VR+"','"+cid+"','"+S+"','"+D+"','"+String.valueOf(java.time.LocalDate.now())+"','"+String.valueOf(java.time.LocalTime.now())+"',12,'"+dis+"'); ";
		...
		btnConfirmBooking.setBackground(new Color(255, 192, 203));
		...
		CID.setIcon(new ImageIcon("E:\\harshu\\documents\\engg\\5th sem\\DBMS Project\\pictures\\b16.png"));
