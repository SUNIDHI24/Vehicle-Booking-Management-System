...
public class auto_confirm {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					auto_confirm window = new auto_confirm();
	...
	private void initialize() {
		...
		lblModeOfPayment.setBounds(10, 185, 131, 22);
		...
		btnConfirmBooking.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
					...
					String query1="select VRegNo from v_details where VID=1 and status ='available';";
					...
					{	
						...
						String query = "insert into booking(VRegNo,CID,Sloc, Dloc, DateOfBooking, TimeOfBooking,rpkm,distance) values ('"+VR+"','"+cid+"','"+S+"','"+D+"','"+String.valueOf(java.time.LocalDate.now())+"','"+String.valueOf(java.time.LocalTime.now())+"',9,'"+dis+"'); ";
		...
		btnConfirmBooking.setBackground(new Color(152, 251, 152));
		...
		CID.setIcon(new ImageIcon("E:\\harshu\\documents\\engg\\5th sem\\DBMS Project\\pictures\\auto.jpg"));
